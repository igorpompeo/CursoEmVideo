...
Exercício 85 - Crie um programa onde o usuário posso digitar sete valores
numéricos e cadastre-os em uma lista única que mantenha separados os valores
pares e impares. No final, mostre os valores pares e ímpares em ordem crescente.

Exercício 86 - Crie um programa que crie uma matriz de dimensão 3x3 e preencha com
...
C) o maior valor da segunda linda.
...
No final, mostre o boletim contendo a média de cada um e permita que o usuário posso mostrar as notas de cada aluno
individualmente.
'''